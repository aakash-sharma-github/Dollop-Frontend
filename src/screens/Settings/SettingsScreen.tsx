...
export function SettingsScreen({
    ...
    const handleLocalMusicToggle = useCallback(
        async (value: boolean) => {
            if (value) {
                ...
                if (permissionStatus !== "granted") {
                    ...
                    if (!granted) {
                        Alert.alert(
                            "Permission denied",
                            "Dollop needs access to your music library.",
                        );
                        return;
                    }
            ...
            >
                    ...
                    <SettingsRow
                        ...
                        description={
                            localLoading
                                ? "Loading…"
                                : localEnabled
                                    ? "Showing tracks from this device"
                    ...
                    {localEnabled && permissionStatus === "granted" && (
                        <SettingsRow
                            ...
                            onPress={() => {
                                ...
                                Alert.alert(
                                    "Refreshing",
                                    "Your local music library is being updated.",
                                );
                            }}
                        />
                    )}
                ...
                <Section title="About">
                    <SettingsRow
                        ...
                        right={
                            <Text
                                style={[typography.labelMd, { color: colors.textTertiary }]}
                            >
                                {APP_VERSION.display}
                            </Text>
                        }
